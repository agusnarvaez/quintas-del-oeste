...
export default function MasterPlan() {
  ...
  return (
    <Element className="container-fluid p-0 px-5 d-flex justify-content-center flex-wrap" id="masterPlan" name='masterPlan'>
      <h2 className='text-quintas-green text-center'>RESERVÁ TU LOTE AHORA EN 3 PASOS</h2>
      <div className='my-5 col-11 row flex-wrap justify-content-center  align-items-center'>

...
export default function Cercanias() {
  return (
    <div className="container-fluid col-3 d-none d-lg-block">
      ...
      <p className="p-0">GENERAL PAZ - 47,7KM</p>
      <p className="p-0">MUNICIPALIDA DE GRAL. RODRÍGUEZ - 2,8KM</p>
      <p className="p-0">CARREFOUR - 4,1KM</p>
      <p className="p-0">ESTACIÓN DE SERVICIO - 3,2KM</p>
    </div>
  )
}
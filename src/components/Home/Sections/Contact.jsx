...
export default function Contact() {
  ...
  return (
    <Element className="container-fluid p-0  flex-nowrap mb-3" id="contact" name='contact'>
      ...
      <div className="container-fluid banner-container p-0 d-flex align-items-center justify-content-center position-relative flex-wrap w-100">
        ...
        <h2 className="text-white fs-2 fw-bolder text-center px-5 col-6">CALIDAD DE VIDA Y CONFORT A SOLO MINUTOS DEL CENTRO DE GENERAL RODRIGUEZ</h2>

       {/*  <div className="d-none d-lg-block contactForm py-lg-3 col-lg-4 bg-white-transparent" >
          <ContactForm/>
        </div> */}
      </div>
      <div className="z-index-150 my-lg-5">
        <LinksInfo/>
      </div>

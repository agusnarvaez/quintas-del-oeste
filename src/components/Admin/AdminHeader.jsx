    ...
    <header className="admin-header position-relative w-100 m-0  d-flex flex-nowrap sticky-top align-items-center justify-content-between bg-admin-primary">
        ...
        {isAuthenticated?
          <>
            ...
            <div className={show?'admin-nav d-flex flex-column':'admin-nav admin-nav-hidden d-flex flex-column'}>
              {user?<div className='admin-profile bg-admin-secondary-dark w-100 m-0 p-0 py-3 mb-3 row justify-content-center'>
              ...
              <ul className='admin-nav-links m-0 list-unstyled text-admin-primary bg-admin-secondary-dark d-flex flex-nowrap align-items-center'>
